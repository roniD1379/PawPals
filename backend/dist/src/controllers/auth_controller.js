...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const rs = yield user_model_1.default.findOne({ 'username': username });
        if (rs != null) {
            return res.status(406).send("username already exists");
        }
        const salt = yield bcrypt_1.default.genSalt(10);
        const encryptedPassword = yield bcrypt_1.default.hash(password, salt);
        const rs2 = yield user_model_1.default.create({ 'username': username, 'password': encryptedPassword, 'firstname': firstname, 'lastname': lastname, 'phoneNumber': phoneNumber });
